...
@employees.route("/<int:department_id>/", methods=["POST"])
@jwt_required()
def create_employees(id):
    ...
    # else:
    # abort(400, description= "department doesn't exist")
    ...
    new_employee.department_id = department
