...
# @assets.route('/service_job/<int:service_job>', methods=["GET"])
# def asset_type_assets (asset_id):
#     asset = Asset.query.get(asset_id)
#     if not asset:
#         return jsonify({'error': 'Asset not found'})
#     service_job_dict_list = []
#     for service_jobs in asset.asset_type_id:
#         asset_type_dict = {'asset_type_id': assettype.asset_type_id, 'description': assettype.description}
#         service_job_dict_list.append(asset_type_dict)
#     asset_dict = {'asset_type': service_job_dict_list, 'asset_id': asset.asset_id, 'asset_name': asset.asset_name, 'serial_number':asset.serial_number }
#     return jsonify(asset_dict)
